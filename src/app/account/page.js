...
export default function AccountPage() {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col">
            <Navbar />
            <main className="flex-grow max-w-7xl mx-auto pt-40 sm:pt-32 pb-16 px-4 sm:px-6 lg:px-8 w-full">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-gray-900 uppercase">My Account</h1>
                ...
                <div className="bg-gray-50 overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                        ...
                        <div className="mt-5 border-t border-gray-200 pt-5">
                            <dl className="sm:divide-y sm:divide-gray-200">
                                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-bold uppercase">{user.name}</dd>
                                </div>
                                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
