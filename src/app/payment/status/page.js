            ...
            {status === 'success' && (
                <div className="space-y-6 animate-fade-in">
                    ...
                    <p className="text-gray-500 font-light max-w-md mx-auto text-lg">
                        Thank you for choosing <span className="font-bold text-black dark:text-white">Fusion of Dried Nuts</span>.
                        Your order is confirmed. We'll notify you when your order is out for delivery.
                    </p>
                    {orderData && (
